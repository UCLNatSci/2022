...
1. Click 'Sign Up'.
1. Agree to the terms of service then create an account using your UCL email address `firstname.surname.21@ucl.ac.uk`.
1. You should see a Project titled something like '[your name] - NSCI0007_22_23'. If you don't, this might be because you didn't use the correct email address in step 3.
...
1. To add your partner as a collaborator, click on your name then enter your partner's full name or email address (in the form `firstname.surname.21@ucl.ac.uk`) in the box.
